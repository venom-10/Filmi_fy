...
export default function MovieDetails() {
  ...
  const api = `https://api.themoviedb.org/3/movie/${param.id}?api_key=ea36bdeb4a287433d73a0a47fbf39fd2&language=en-US`;
  useEffect(() => {
  ...
  return (
    <>
    {title && overview ?
      <div className="__main bg-gray-700 dark:bg-gray-200 mob:h-screen flex justify-center items-center">
        ...
        <div className={showForm ? class4 : class3}>
          ...
          >
            <div className="flex flex-col w-full">
              <label className="text-white font-bold text-lg">Movie Name</label>
              <input
            ...
            <div className="flex flex-col w-full">
              <label className="text-white font-bold text-lg">Full Name</label>
              <input
                className="rounded-md drop-shadow-md shadow-md w-full px-3 py-2 font-semibold"
                type="text"
                name="fullName"
